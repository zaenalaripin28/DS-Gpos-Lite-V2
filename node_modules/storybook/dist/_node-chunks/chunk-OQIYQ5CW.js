...
import {
  require_build
} from "./chunk-IPVYBROC.js";
import {
  STORYBOOK_FN_PLACEHOLDER,
  generateDummyArgsFromArgTypes,
  loadConfig,
  printConfig
} from "./chunk-Y7ERQ2TE.js";
import {
  StorybookError
} from "./chunk-F5GMSFLV.js";
import {
  isI18nPackage,
  isRouterPackage,
...
var getComponentVariableName = async (name) => (await import("./camelcase-H3VPKIOM.js")).default(name.replace(/^[^a-zA-Z_$]*/, ""), { pascalCase: !0 }).replace(/[^a-zA-Z_$]+/, "");
