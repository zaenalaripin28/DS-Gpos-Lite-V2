...
import {
  pLimit
} from "../_node-chunks/chunk-5SGXAHET.js";
import {
  UniversalStore,
  analyzeTestResults,
  debounce,
  ...
  useStatics,
  withTelemetry
} from "../_node-chunks/chunk-OQIYQ5CW.js";
import "../_node-chunks/chunk-IPVYBROC.js";
import {
  Tag
} from "../_node-chunks/chunk-Y7ERQ2TE.js";
import {
  UNIVERSAL_STATUS_STORE_OPTIONS,
  createStatusStore,
  detectPnp
} from "../_node-chunks/chunk-AHSHBPIC.js";
import {
  require_lib,
  require_src
} from "../_node-chunks/chunk-P5UJH34Z.js";
import {
  StorybookError
} from "../_node-chunks/chunk-F5GMSFLV.js";
import {
  isTelemetryModuleEnabled,
  telemetry
} from "../_node-chunks/chunk-WMHXN3YR.js";
import "../_node-chunks/chunk-QGUN5POW.js";
import "../_node-chunks/chunk-DTA6RZFF.js";
import {
  execa,
  require_cross_spawn,
  resolveImport,
...
} from "../_node-chunks/chunk-WKCYHYMS.js";
import "../_node-chunks/chunk-BJVLY7MM.js";
import "../_node-chunks/chunk-IYHX5ZFZ.js";
import {
  logger,
  require_pretty_hrtime
} from "../_node-chunks/chunk-FZZ2KQY7.js";
import "../_node-chunks/chunk-2VPOESW7.js";
import {
  optionalEnvToBoolean
} from "../_node-chunks/chunk-4OKXR4H4.js";
import "../_node-chunks/chunk-C6PIYNCR.js";
import {
  invariant,
  up2 as up
} from "../_node-chunks/chunk-OHGHOIHA.js";
import {
  importModule,
  resolvePackageDir
} from "../_node-chunks/chunk-EGC27Z5J.js";
import "../_node-chunks/chunk-MRJ66S5A.js";
import {
  dirname,
  extname,
  isAbsolute,
  ...
  relative,
  resolve
} from "../_node-chunks/chunk-MJL2XQWP.js";
import {
  require_dist
} from "../_node-chunks/chunk-6FSCRCDN.js";
import {
  require_picocolors
} from "../_node-chunks/chunk-JQLGW5TU.js";
import {
  slash
} from "../_node-chunks/chunk-REFVGE2Y.js";
import "../_node-chunks/chunk-QJO6IJ3P.js";
import {
  __commonJS,
  __esm,
  __export,
  ...
  __toCommonJS,
  __toESM
} from "../_node-chunks/chunk-EBFUVDU3.js";
...
GFS4: `), console.error(m);
    ...
    function patch(fs2) {
      ...
      function readFile7(path2, options, cb) {
  ...
  "../../node_modules/watchpack/lib/reducePlan.js"(exports, module) {
    ...
    module.exports = (plan, limit) => {
      ...
      for (; currentCount > limit; ) {
        ...
        for (let node2 of treeMap.values()) {
          if (node2.entries <= 1 || !node2.children || !node2.parent || node2.children.length === 0 || node2.children.length === 1 && !node2.value) continue;
          let cost = node2.entries - 1 >= overLimit ? node2.entries - 1 - overLimit : overLimit - node2.entries + 1 + limit * 0.3;
          cost < bestCost && (bestNode = node2, bestCost = cost);
        }
        if (!bestNode) break;
        ...
        for (let node2 of queue)
          if (node2.active = !1, node2.entries = 0, node2.children)
    ...
    var stringToRegexp = (ignored) => {
      ...
      watch(arg1, arg2, arg3) {
        ...
        let { fileWatchers, directoryWatchers } = this, { ignored } = this.watcherOptions, filter = (path2) => !ignored(path2), addToMap = (map, key2, item) => {
          let list2 = map.get(key2);
          list2 === void 0 ? map.set(key2, item) : Array.isArray(list2) ? list2.push(item) : map.set(key2, [list2, item]);
...
`),
    ...
    pp$5.checkParams = function(node2, allowDuplicates) {
      for (var nameHash = /* @__PURE__ */ Object.create(null), i = 0, list2 = node2.params; i < list2.length; i += 1) {
        var param = list2[i];
    ...
    for (i = 0, list2 = [9, 10, 11, 12, 13, 14]; i < list2.length; i += 1)
      ecmaVersion = list2[i], buildUnicodeData(ecmaVersion);
    ...
    RegExpValidationState.prototype.eatChars = function(chs, forceU) {
      forceU === void 0 && (forceU = !1);
      for (var pos = this.pos, i = 0, list2 = chs; i < list2.length; i += 1) {
        var ch = list2[i], current2 = this.at(pos, forceU);
...
var require_address = __commonJS({
  "../../node_modules/address/lib/address.js"(exports, module) {
    ...
    address.interface = function(family, name2) {
      ...
      for (var i = -1; i < 8; i++) {
        var interfaceName = name2 + (i >= 0 ? i : ""), items = interfaces[interfaceName];
        if (items)
...
async function getManagerBuilder() {
  return await import("../_node-chunks/builder-manager-SBMOFRIH.js");
}
  ...
  async function onChangeOrRemove(absolutePath, removed) {
    ...
    !removed && isDirectory(absolutePath) && await Promise.all(
      specifiers.filter((specifier) => importPath.startsWith(specifier.directory)).map(async (specifier) => {
        ...
        ), { globby } = await import("../_node-chunks/globby-UPM6MPAK.js");
...
function registerIndexJsonRoute({
  ...
  let maybeInvalidate = debounce(
    () => {
      channel.emit(STORY_INDEX_INVALIDATED), onStoryIndexInvalidated?.();
    },
    DEBOUNCE,
...
var getDocgenRenderData = (component, hasPropTypeError) => hasPropTypeError ? {} : component.reactDocgen ? {
...
function renderSubcomponentNote(subcomponentName, subcomponent) {
  let hasPropTypeError = !!subcomponent.error, { parsed, engine, filePath, exportName } = getDocgenRenderData(
    subcomponent,
    hasPropTypeError
  ), propEntries = Object.entries(parsed?.props ?? {}), tags = subcomponent.jsDocTags && typeof subcomponent.jsDocTags == "object" ? Object.entries(subcomponent.jsDocTags).flatMap(
...
async function getManifests(presets, { watch: watch2 } = {}) {
  let generator = await presets.apply("storyIndexGenerator");
  invariant(generator, "storyIndexGenerator must be configured");
  let index2 = await generator.getIndex(), manifestEntries = Object.values(index2.entries).filter(
...
async function writeManifests(outputDir, presets) {
  try {
    let manifests = await getManifests(presets), docsManifest = isDocsManifest(manifests.docs) ? manifests.docs : void 0;
    if (Object.keys(manifests).length === 0)
      return;
    await mkdir(join(outputDir, "manifests"), { recursive: !0 }), await Promise.all(
      Object.entries(manifests).map(
        ([name2, content3]) => writeFile2(join(outputDir, "manifests", `${name2}.json`), JSON.stringify(content3))
      )
...
function registerManifests({ app, presets }) {
  app.get("/manifests/:name.json", async (req, res) => {
    try {
      let manifest = (await getManifests(presets, { watch: !0 }))[req.params.name];
    ...
    try {
      let manifests = await getManifests(presets, { watch: !0 }), componentsManifest = manifests.components, docsManifest = isDocsManifest(manifests.docs) ? manifests.docs : void 0;
...
import { dirname as dirname2, extname as extname2, join as join5, normalize as normalize2, relative as relative4, resolve as resolve3, sep } from "node:path";
...
function splice(list2, start2, remove, items) {
  ...
  if (start2 < 0 ? start2 = -start2 > end ? 0 : end + start2 : start2 = start2 > end ? end : start2, remove = remove > 0 ? remove : 0, items.length < 1e4)
    parameters = Array.from(items), parameters.unshift(start2, remove), list2.splice(...parameters);
  else
    for (remove && list2.splice(start2, remove); chunkStart < items.length; )
      parameters = items.slice(chunkStart, chunkStart + 1e4), parameters.unshift(start2, 0), list2.splice(...parameters), chunkStart += 1e4, start2 += 1e4;
}
...
var own4 = {}.hasOwnProperty, CONTINUE = Symbol("continue"), EXIT = Symbol("exit"), SKIP = Symbol("skip");
...
var addStats = (stat2, acc) => {
  Object.entries(stat2).forEach(([key2, value]) => {
    let statsKey = key2;
...
var makeAbsolute = (otherImport, normalizedPath, workingDir) => otherImport.startsWith(".") ? slash(resolve3(workingDir, normalizeStoryPath(join5(dirname2(normalizedPath), otherImport)))) : otherImport, StoryIndexGenerator = class _StoryIndexGenerator {
  ...
  static async findMatchingFiles(specifier, workingDir, ignoreWarnings = !1) {
    ...
    if (cached)
      return cached;
    let pathToSubIndex = {}, globCwd = slash(resolve3(workingDir, specifier.directory)), globPattern = specifier.files.startsWith("!") ? `./${specifier.files}` : specifier.files, { globby } = await import("../_node-chunks/globby-UPM6MPAK.js"), files = await globby(globPattern, {
      absolute: !0,
      cwd: globCwd,
  ...
  async extractStories(specifier, absolutePath, projectTags = []) {
    ...
    if (storyEntries.some((entry) => entry.tags.includes(Tag.AUTODOCS)) && !!this.options.docs && this.options.build?.test?.disableAutoDocs !== !0) {
      let name2 = this.options.docs?.defaultName ?? "Docs", { metaId } = indexInputs[0], entry = storyEntries[0], id = toId(metaId ?? entry.title, name2), tags = combineTags(...projectTags, ...indexInputs[0].tags ?? []);
      return {
        entries: [{
          id,
          title: entry.title,
  ...
  async extractDocs(specifier, absolutePath, projectTags = []) {
    ...
    try {
      let normalizedPath = normalizeStoryPath(relativePath), importPath = slash(normalizedPath), content3 = await readFile(absolutePath, { encoding: "utf8" }), result = await analyzeMdx(content3);
      ...
      let defaultName = this.options.docs?.defaultName ?? "Docs", name2 = result.name || (csfEntry ? autoName(importPath, csfEntry.importPath, defaultName) : defaultName), id = toId(csfEntry?.extra.metaId || title, name2), tags = combineTags(
        ...projectTags,
        ...csfEntry?.tags ?? [],
        ...result.metaTags ?? [],
...
async function buildStaticStandalone(options) {
  ...
  ), features?.componentsManifest && effects.push(writeManifests(options.outputDir, presets))), core3?.disableProjectJson || effects.push(
...
import { CLI_COLORS as CLI_COLORS2, deprecate, logger as logger21, prompt } from "storybook/internal/node-logger";
import { MissingBuilderError as MissingBuilderError3, NoStatsForViteDevError } from "storybook/internal/server-errors";
import { detectAgent, oneWayHash, telemetry as telemetry4 } from "storybook/internal/telemetry";
...
// src/channels/postmessage/index.ts
var { document: document4, location } = global3;
...
var MAP = {
  ...
  use(route, ...fns) {
    let handlers = [].concat.apply([], fns), { keys, pattern } = parse7(route, !0);
    return this.routes.push({ keys, pattern, method: "", handlers, midx: MAP[""] }), this;
  }
  add(method, route, ...fns) {
    let { keys, pattern } = parse7(route), handlers = [].concat.apply([], fns);
...
var mount = (fn) => fn instanceof Polka ? fn.attach : fn, Polka = class _Polka extends Trouter {
  constructor(opts = {}) {
    super(), this.parse = parse9, this.server = opts.server, this.handler = this.handler.bind(this), this.onError = opts.onError || onError, this.onNoMatch = opts.onNoMatch || this.onError.bind(null, { status: 404 }), this.attach = (req, res) => setImmediate2(this.handler, req, res);
  }
  use(base, ...fns) {
...
var GitDiffProvider = class {
  constructor(cwd = process.cwd(), fileSystem = { watch, readFile: readFile2, stat }) {
    this.cwd = cwd;
    ...
    if (!this.watchingStopped)
      try {
        ...
        return currentWatcher?.close(), watcher.on("error", () => {
          watcher.close(), this.headWatcher === watcher && (this.headWatcher = void 0), this.packedRefsWatcher === watcher && (this.packedRefsWatcher = void 0), this.branchWatcher === watcher && (this.branchWatcher = void 0), this.stopWatching(), logger9.warn(
  ...
  reconfigureBranchWatcher(gitDir) {
    this.configureBranchWatcher(gitDir).catch(() => {
      logger9.warn("Change detection failed to reconfigure git branch watcher."), this.stopWatching();
    });
  }
  dispose() {
    this.stopWatching();
...
// src/core-server/change-detection/ChangeDetectionService.ts
...
// src/core-server/change-detection/dependency-graph/ResolverFactory.ts
    ...
    if (Array.isArray(alias))
      for (let entry of alias)
        if (typeof entry.find == "string") {
          let find2 = entry.find.replace(/\/$/, ""), replacement = entry.replacement.replace(/\/$/, "");
          out[find2] = [replacement];
        } else
          skippedRegex.push(String(entry.find));
    else
      for (let [find2, replacement] of Object.entries(alias))
        out[find2.replace(/\/$/, "")] = [replacement.replace(/\/$/, "")];
    if (skippedRegex.length > 0) {
      ...
      if (newPatterns.length > 0) {
        ...
        for (let pattern of skippedRegex)
          logger10.debug(`ChangeDetectionResolverFactory: skipping regex alias '${pattern}'`);
    }
...
// src/core-server/change-detection/dependency-graph/ReverseIndex.ts
var ReverseIndexImpl = class {
  ...
  record(dep, story, depth) {
    ...
    let previous2 = inner.get(story);
    if (previous2 === void 0 || depth < previous2) {
...
// src/core-server/change-detection/dependency-graph/DependencyGraphBuilder.ts
import { cpus } from "node:os";
import { logger as defaultLogger } from "storybook/internal/node-logger";

// src/core-server/change-detection/dependency-graph/ParseResolveCache.ts
import { readFile as readFile3 } from "node:fs/promises";
import { parseBarrelInfo } from "storybook/internal/oxc-parser";

// src/core-server/change-detection/dependency-graph/scope.ts
...
var BARREL_FOLLOW_MAX_DEPTH = 10, ParseResolveCache = class {
  ...
  async followBarrel(barrelPath, requestedNames) {
    let barrels = /* @__PURE__ */ new Set(), results = await Promise.all(
      Array.from(requestedNames, (name2) => this.followName(barrelPath, name2, /* @__PURE__ */ new Set(), 0, barrels))
   ...
   */
  async followName(barrelPath, name2, visited, depth, barrels) {
    if (depth > BARREL_FOLLOW_MAX_DEPTH)
      return this.logger.debug(
        `Change detection: barrel chain depth limit reached at ${barrelPath} (looking for "${name2}")`
      ), null;
    if (visited.has(barrelPath))
      return null;
    visited.add(barrelPath), barrels.add(barrelPath);
    let info = await this.barrelInfoOnce(barrelPath), entry = info.named.get(name2);
    if (entry) {
...
// src/core-server/change-detection/dependency-graph/walkFromStory.ts
...
// src/core-server/change-detection/dependency-graph/IncrementalPatcher.ts
...
var IncrementalPatcher = class {
  ...
  async patch(event) {
    let path2 = normalize(event.path);
    if (this.cache.invalidate(path2), event.kind === "add") {
      this.isStoryFile(path2) && await this.walkStory(path2);
      return;
    }
    if (event.kind === "unlink") {
      let dependentsSet = new Set(this.reverseIndex.lookup(path2).keys());
      this.graph.delete(path2), this.reverseIndex.removeStory(path2);
      let storiesToWalk2 = [];
      for (let story of dependentsSet)
        story === path2 || !this.isStoryFile(story) || (this.reverseIndex.removeStory(story), storiesToWalk2.push(story));
      await Promise.all(storiesToWalk2.map((story) => this.walkStory(story)));
      return;
    }
    let affectedStories = new Set(this.reverseIndex.lookup(path2).keys());
    this.isStoryFile(path2) && affectedStories.add(path2);
    let oldDeps = this.graph.get(path2);
    if (oldDeps !== void 0) {
      let newDeps = await this.cache.resolveOnce(path2);
...
// src/core-server/change-detection/parser-registry/ParserRegistry.ts
...
var ParserRegistry = class {
  ...
  register(plugin) {
    for (let ext of plugin.extensions) {
      ...
      this.byExtension.has(lower) && logger11.debug(`ParserRegistry: ${lower} parser overridden`), this.byExtension.set(lower, plugin.parse);
    }
  }
  parserFor(filePath) {
...
// src/core-server/change-detection/parser-registry/builtins.ts
import { parseWithOxc as parseWithOxc2 } from "storybook/internal/oxc-parser";

// src/core-server/change-detection/parser-registry/mdx-parse.ts
...
function mdxParse(source) {
  ...
  for (; match !== null; ) {
    let specifier = match[1], key2 = `static:${specifier}`;
    seen.has(key2) || (seen.add(key2), edges.push({ specifier, kind: "static", importedNames: null })), match = MDX_IMPORT_REGEX.exec(stripped);
  }
  return edges;
}
...
var oxcImportParser = {
  ...
  async parse({ filePath, source }) {
    return parseWithOxc2(filePath, source);
  }
}, mdxImportParser = {
  extensions: [".mdx"],
  async parse({ source }) {
...
function getStoryIdsByAbsolutePath(cache4, storyIndex, workingDir) {
  let cached = cache4.get(storyIndex);
  ...
  }), cache4.set(storyIndex, { workingDir, storyIdsByFile }), storyIdsByFile;
}
...
var ChangeDetectionService = class {
  constructor(options) {
    ...
    this.storyIdsByFileCache = /* @__PURE__ */ new WeakMap();
    /**
  ...
  start(adapter, enabled) {
    if (enabled === !1) {
      logger12.debug("Change detection disabled."), this.resolveReadiness({
        status: "unavailable",
        reason: "disabled"
      });
      return;
    ...
    if (!adapter) {
      logger12.warn("Change detection unavailable: builder does not support change detection"), this.resolveReadiness({
        status: "unavailable",
        reason: "builder does not support change detection"
      });
      return;
    }
    logger12.debug("Change detection enabled."), this.adapter = adapter, this.startInternal().catch((error) => {
      if (this.disposed)
        return;
      let failure = error instanceof Error ? error : new ChangeDetectionFailureError(String(error));
      logger12.error(`Change detection failed to start: ${failure.message}`), this.resolveReadiness({ status: "error", error: failure }), this.dispose().catch(() => {
      });
    });
  }
  /**
  ...
  async startInternal() {
    ...
    let resolveConfig = await adapter.getResolveConfig(), projectRoot = normalize(resolveConfig.projectRoot ?? this.workingDir), pluginParsers = this.options.presets ? await this.options.presets.apply("experimental_importParsers", []) : [], registry = new ParserRegistry({
      ...
      pluginParsers
    }), resolver2 = new ChangeDetectionResolverFactory(resolveConfig), workspaceRoots = /* @__PURE__ */ new Set([normalize(getProjectRoot2())]), storyIndex = await (await this.options.storyIndexGeneratorPromise).getIndex(), storyIdsByFile = getStoryIdsByAbsolutePath(
      this.storyIdsByFileCache,
      storyIndex,
      this.workingDir
    );
    if (this.storyFiles = new Set(storyIdsByFile.keys()), this.disposed)
      return;
    ...
    this.unsubscribeFileChange = adapter.onFileChange((event) => {
      this.disposed || eventBuffer.push(event);
    });
    let { reverseIndex, graph } = await this.dependencyGraphBuilder.build(this.storyFiles);
    if (!this.disposed) {
      this.reverseIndex = reverseIndex, this.dumpDebugSnapshot(reverseIndex, graph, projectRoot, workspaceRoots, cache4), this.incrementalPatcher = new IncrementalPatcher({
        ...
        projectRoot,
        cache: cache4,
        isStoryFile: (path2) => this.storyFiles.has(normalize(path2))
      ...
      this.unsubscribeFileChange = adapter.onFileChange((event) => {
        this.disposed || (this.patchQueue = this.patchQueue.then(() => this.handleFileChange(event)).catch(() => {
        }));
      }), adapter.onStartupFailure && (this.unsubscribeStartupFailure = adapter.onStartupFailure((event) => {
        this.disposed || (logger12.warn(`Change detection unavailable: ${event.reason}`), this.resolveReadiness({
          status: "unavailable",
          reason: event.reason,
          error: event.error
        }), this.dispose());
      })), this.getIndexBaselineService().start(), this.getGitDiffProvider().onGitStateChange(() => {
  ...
  onStoryIndexInvalidated() {
    this.disposed || (this.refreshStoryFiles().catch(() => {
  ...
  async refreshStoryFiles() {
    if (!(this.refreshInFlight || !this.incrementalPatcher)) {
      ...
      try {
        let storyIndex = await (await this.options.storyIndexGeneratorPromise).getIndex();
        if (this.disposed)
          return;
        let storyIdsByFile = getStoryIdsByAbsolutePath(
          this.storyIdsByFileCache,
          storyIndex,
          this.workingDir
        ), next = new Set(storyIdsByFile.keys()), previous2 = this.storyFiles, added = [];
        for (let path2 of next)
          previous2.has(path2) || added.push(path2);
        let removed = [];
        for (let path2 of previous2)
          next.has(path2) || removed.push(path2);
        if (added.length === 0 && removed.length === 0)
          return;
        this.storyFiles = next;
        for (let path2 of added)
          this.patchQueue = this.patchQueue.then(() => this.handleFileChange({ kind: "add", path: path2 })).catch(() => {
          });
        for (let path2 of removed)
          this.patchQueue = this.patchQueue.then(() => this.handleFileChange({ kind: "unlink", path: path2 })).catch(() => {
          });
      } finally {
        this.refreshInFlight = !1;
      }
  ...
  async dumpDebugSnapshot(reverseIndex, graph, projectRoot, workspaceRoots, cache4) {
    ...
    try {
      await writeFile4(outPath, JSON.stringify(snapshot, null, 2), "utf8"), logger12.debug(`Change detection: graph debug snapshot written to ${outPath}`);
    } catch (error) {
      logger12.warn(
  ...
  async dispose() {
    this.disposed = !0, this.rerunAfterCurrentScan = !1, this.debounceTimer && (clearTimeout(this.debounceTimer), this.debounceTimer = void 0), this.unsubscribeFileChange?.(), this.unsubscribeFileChange = void 0, this.unsubscribeStartupFailure?.(), this.unsubscribeStartupFailure = void 0, this.gitDiffProvider?.dispose(), await this.patchQueue.catch(() => {
    }), await disposeOxcParsePool().catch(() => {
    });
  }
  async handleFileChange(event) {
    if (!(this.disposed || !this.incrementalPatcher)) {
      ...
      this.disposed || this.scheduleScan(this.debounceMs);
    }
  }
  ...
  async scan() {
    if (!(this.disposed || !this.reverseIndex || (await this.patchQueue.catch(() => {
    }), this.disposed || !this.reverseIndex))) {
      ...
      this.scanInFlight = !0;
      try {
        let nextStatuses = await this.buildStatuses(this.reverseIndex);
        if (this.disposed)
          return;
        ...
        if (error instanceof ChangeDetectionUnavailableError)
          logger12.warn(`Change detection unavailable: ${error.message}`), this.resolveReadiness({
            status: "unavailable",
            reason: error.message,
            error
          }), await this.dispose();
        else if (error instanceof ChangeDetectionFailureError)
          logger12.error(`Change detection failed: ${error.message}`), this.resolveReadiness({
            status: "error",
            error
          });
        else {
          ...
          logger12.error(`Change detection failed: ${failure.message}`), this.resolveReadiness({
            status: "error",
            error: failure
          });
        }
  ...
  async buildStatuses(reverseIndex) {
    ...
    ), scannedFiles = /* @__PURE__ */ new Set([...changedFiles, ...newFiles]), storyIndex = await storyIndexGenerator.getIndex(), baselineStatuses = buildIndexBaselineStatuses(storyIndex, baselineEntryIds), storyIdsByFile = getStoryIdsByAbsolutePath(
      this.storyIdsByFileCache,
      storyIndex,
      this.workingDir
    ), statuses = /* @__PURE__ */ new Map();
    for (let changedFile of scannedFiles) {
      let affectedStoryFiles = reverseIndex.lookup(changedFile), allEntries = new Map(affectedStoryFiles);
...
Note: BROWSER environment variable is set to "${browserEnv}". To disable browser opening, use BROWSER=none or the --ci flag.` : "";
      logger14.error(import_ts_dedent3.dedent`
...
async function storybookDevServer(options, server) {
  ...
  if (!options.ignorePreview && (features.changeDetection || changeDetectionService.start(void 0, !1), logger15.debug("Starting preview.."), previewResult = await previewBuilder.start({
    startTime: process.hrtime(),
    options,
    router: app,
    server,
    ...
    throw logger15.error("Failed to build the preview"), process.exitCode = 1, await changeDetectionService.dispose().catch(() => {
    ...
    try {
      ...
      logger15.warn("Change detection: adapter initialisation failed"), logger15.debug(err instanceof Error ? err.stack ?? err.message : String(err));
    }
    changeDetectionService.start(adapter, !0);
  }
  ...
  try {
    ...
    throw await managerBuilder?.bail().catch(() => {
    }), await previewBuilder?.bail().catch(() => {
    }), e;
  }
...
var import_picocolors7 = __toESM(require_picocolors(), 1), import_pretty_hrtime = __toESM(require_pretty_hrtime(), 1), import_ts_dedent5 = __toESM(require_dist(), 1);
import { CLI_COLORS, logger as logger16 } from "storybook/internal/node-logger";

// src/core-server/utils/update-check.ts
var import_picocolors6 = __toESM(require_picocolors(), 1), import_ts_dedent4 = __toESM(require_dist(), 1);
...
function createUpdateMessage(updateInfo, version2) {
  ...
  try {
    ...
    updateMessage = updateInfo.success && semver.lt(version2, updateInfo.data.latest.version) ? import_ts_dedent4.dedent`
          ${colors.orange(
...
var getServerPort = (port, { exactPort } = {}) => (0, import_detect_port.default)(port).then((freePort) => (freePort !== port && exactPort && process.exit(-1), freePort)).catch((error) => {
  logger17.error(error), process.exit(-1);
...
async function getServer(options) {
  ...
  options.sslCert || (logger18.error("Error: --ssl-cert is required with --https"), process.exit(-1)), options.sslKey || (logger18.error("Error: --ssl-key is required with --https"), process.exit(-1));
  let sslOptions = {
    ca: await Promise.all((options.sslCa || []).map((ca) => readFile4(ca, { encoding: "utf8" }))),
    cert: await readFile4(options.sslCert, { encoding: "utf8" }),
    key: await readFile4(options.sslKey, { encoding: "utf8" })
  };
...
var checkPackageCompatibility = async (dependency, context) => {
  ...
  try {
    ...
    return skipErrors || logger19.log(
...
var warnOnIncompatibleAddons = async (currentStorybookVersion, packageManager) => {
  ...
  incompatiblePackagesMessage && logger20.warn(incompatiblePackagesMessage);
};

// src/core-server/utils/warnWhenUsingArgTypesRegex.ts
var import_picocolors9 = __toESM(require_picocolors(), 1), import_ts_dedent6 = __toESM(require_dist(), 1);
import { readFile as readFile5 } from "node:fs/promises";
import { core as core2 } from "storybook/internal/babel";
import { babelParse } from "storybook/internal/csf-tools";
async function warnWhenUsingArgTypesRegex(previewConfigPath, config) {
  let previewContent = previewConfigPath ? await readFile5(previewConfigPath, { encoding: "utf8" }) : "";
  (config?.addons?.some(
    (it) => typeof it == "string" ? it === "@chromatic-com/storybook" : it.name === "@chromatic-com/storybook"
  ) ?? !1) && previewConfigPath && previewContent.includes("argTypesRegex") && new core2.File(
    { filename: previewConfigPath },
    { code: previewContent, ast: babelParse(previewContent) }
  ).path.traverse({
    Identifier: (path2) => {
      if (path2.node.name === "argTypesRegex") {
        let message = import_ts_dedent6.dedent`
...
async function buildDevStandalone(options) {
  ...
  !options.ci && !options.smokeTest && options.port != null && port !== options.port && (await prompt.confirm({
    message: import_ts_dedent7.dedent`
        Port ${options.port} is not available. 
        Would you like to run Storybook on port ${port} instead?
      `,
    initialValue: !0
  }) || process.exit(1));
  let cacheKey = oneWayHash(relative(getProjectRoot3(), configDir));
  ...
  options.smokeTest && (outputDir = cacheOutputDir), options.port = port, options.versionCheck = versionCheck, options.configType = "DEVELOPMENT", options.configDir = configDir, options.cacheKey = cacheKey, options.outputDir = outputDir, options.serverChannelUrl = getServerChannelUrl(port, options), options.localAddress = localAddress, options.networkAddress = networkAddress, options.pnp = await detectPnp(), options.pnp && deprecate(import_ts_dedent7.dedent`
  ...
  try {
    ...
    logger21.warn("Storybook failed to check addon compatibility"), logger21.debug(`${e instanceof Error ? e.stack : String(e)}`);
  }
  try {
  ...
  if (options.host === "0.0.0.0" && (!allowedHosts || allowedHosts !== !0 && allowedHosts.length === 0) && logger21.warn(import_ts_dedent7.dedent`
  ...
  if (resolvedPreviewBuilder.includes("builder-vite")) {
    let deprecationMessage = (0, import_ts_dedent7.dedent)(`Using CommonJS in your main configuration file is deprecated with Vite.
    ...
    let mainJsContent = await readFile6(mainJsPath, { encoding: "utf8" }), CJS_CONTENT_REGEX = /\bmodule\.exports\b|\bexports[.[]|\brequire\s*\(|\bObject\.(?:defineProperty|defineProperties|assign)\s*\(\s*exports\b/, strippedContent = stripCommentsAndStrings(mainJsContent);
  ...
  if (options.smokeTest) {
    ...
    problems.length > 0 ? (logger21.error("Smoke tests failed."), logger21.log(problems.map((p) => p.stack).join(`
`))) : logger21.step(CLI_COLORS2.success("Smoke tests passed, exiting.")), logger21.outro(""), process.exit(problems.length > 0 ? 1 : 0);
  } else {
...
async function loadStorybook(options) {
  let configDir = resolve(options.configDir), cacheKey = oneWayHash2(relative(getProjectRoot4(), configDir));
...
var buildIndex = async (options) => {
  ...
  logger22.info(`Writing index to ${options.outputFile}`), await writeFile5(options.outputFile, JSON.stringify(index2));
};
