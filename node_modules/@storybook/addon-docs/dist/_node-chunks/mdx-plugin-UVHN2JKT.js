...
import {
  compile
} from "./chunk-JVI7RVRQ.js";
import "./chunk-D4SIGUWV.js";
import "./chunk-T7DQEDES.js";
import {
  __commonJS,
  __toESM
...
async function mdxPlugin(options) {
  let include = /\.mdx$/, filter = createFilter(include), { presets } = options, mdxPluginOptions = (await presets.apply("options", {}))?.mdxPluginOptions, rehypeSlug = (await import("./rehype-slug-B4J4ET76.js")).default, rehypeExternalLinks = (await import("./rehype-external-links-X63T3A2B.js")).default;
  return {
